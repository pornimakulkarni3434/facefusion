...
def parse_args() -> None:
	...
	program.add_argument('--frame-processors', help = wording.get('frame_processors_help'), dest = 'frame_processors', default = 'face_swapper')
	...
	program.add_argument('--execution-providers', help = wording.get('execution_providers_help'), dest = 'execution_providers', default = 'cpu')
